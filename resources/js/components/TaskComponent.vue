<template>
    <div class="w-full py-2 flex">
        ...
        <div v-if="editModal" class="overflow-y-auto transition-opacity text-black ">
            ...
            <div class="z-50 flex flex-col m-auto h-fit max-w-[300px] md:max-w-sm lg:max-w-lg xl:max-w-5xl bg-white space-y-2 md:space-y-6 fixed inset-0  rounded-sm" >
                <button @click.prevent="closeEditModal" class="absolute right-3 top-3 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                </button>
                <form class="px-2 flex flex-col md:px-6 pb-6 pt-2 space-y-6 w-full">
